    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleParameterTypes", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Listings_DriveTypes_DriveTypeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Listings_GearboxTypes_GearboxTypeId",
                        column: x => x.GearboxTypeId,
                        principalTable: "GearboxTypes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Listings_VehicleBrands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "VehicleBrands",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Listings_VehicleCategories_VehicleCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListingFeatures_VehicleFeatures_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingParameters", x => x.id);
                    table.ForeignKey(
                        name: "FK_ListingParameters_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListingParameters_VehicleParameterTypes_ParameterTypeId",
                        column: x => x.ParameterTypeId,
                        principalTable: "VehicleParameterTypes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingParameters_ListingId",
                table: "ListingParameters",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_ListingParameters_ParameterTypeId",
                table: "ListingParameters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_GearboxTypeId",
                table: "Listings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_VehicleCategoryId",
                table: "Listings",
